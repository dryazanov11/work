...
class TestTmCore(BaseCase):
    ...
    def setup(self):
        ...
        self.request_metadata = "{'WorkflowId':'db648adb-aa34-4b08-a4b0-e4a11a6b9e44','Name':'РўРµСЃС‚ РїСЂРѕС„РёР»СЏ','InitialTransitionId':'c63356eb-092e-4b3d-a9e1-9059ae94bad6','ProcessContext':{'patient':{'idMPI':'00882d8f-7286-4d09-b1e9-649343d9d690','gender':'1','fullName':'FirstName SecondName','birthDate':'1992-03-15','identityDocument':{'code':'1111:858445','system':'14'},'registeredInTheRegion':false},'appointment':{'requestedPeriod':{'end':'16:45','start':'16:45'}},'attachedfiles':[],'serviceRequest':{'REGIS':[],'urgency':'3','category':'4','reasonCode':'9','performerOrganization':'4107450a-67a2-e4a4-ac5d-688cb9c3b70f','requesterOrganization':'4107450a-67a2-e4a4-ac5d-688cb9c3b70f'},'requesterCondition':{'codeMKB':'Z00.6','anamnesis':'С‚РµСЃС‚','complaints':'С‚РµСЃС‚2'},'requesterPractitioner':{'telecom':{'email':'','phone':'111-00-99'},'fullName':'РќР°РїСЂР°РІР»СЏСЋС‰РёР№ Р’СЂР°С‡','position':'4','specialty':'','department':'4107450a-67a2-e4a4-ac5d-688cb9c3b70f','identityDocument':{'code':'00000000002','system':'223'}}},'roleContext':{'c7ec2fc0-982c-4ec1-ae84-c7ec1347ddfb':{'idMPI':'689ae90d-8779-4005-a443-1cee7d24e719','idIP':'00000000-0000-0000-2222-000000000000'}}}".encode('UTF-8')
    ...
    def test_metadata(self):
        ...
        Assertions.assert_expectedvalue_equal_receivedvalue(response1, response1.json()['result']['metadata']['scopedMetadata']['Целевая организация'],
                                                           'Поликлиническое отделение №77', 'Значение целевой МО не соответствует ожидаемому')  #проверки, что значения в ответе будут соответствовать ожидаемым
